...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(
            MyCollectionViewCell.nib(), forCellWithReuseIdentifier: MyCollectionViewCell.identifier)
        collectionViewCircle.register(
            CircleCollectionViewCell.self, forCellWithReuseIdentifier: CircleCollectionViewCell.identifier
        )
    ...
    override func viewDidLayoutSubviews() {
        ...
        CGRect(
            x: 0, y: safeArea.top + 100, width: view.frame.size.width,
            height: view.frame.size.height - safeArea.top - 100
        ).integral
        // Set the frame for collectionViewCircle on top of collectionView
        collectionViewCircle.frame =
        CGRect(x: 0, y: safeArea.top, width: view.frame.size.width, height: 75).integral
    }
}
                          ...
                          CHTCollectionViewDelegateWaterfallLayout
{
    ...
    func collectionView(
        ...
        if collectionView.tag == 1 {
            return CGSize(width: view.frame.size.width / 2, height: photos[indexPath.row].height)
    ...
    -> UICollectionViewCell
    {
        if collectionView.tag == 1 {
            ...
            collectionView.dequeueReusableCell(
                withReuseIdentifier: MyCollectionViewCell.identifier, for: indexPath)
            ...
            let cell =
            collectionViewCircle.dequeueReusableCell(
                withReuseIdentifier: CircleCollectionViewCell.identifier, for: indexPath)
    ...
    //    @nonobjc func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
    //        if collectionView.tag == 1 {
    //            return CGSize(width: view.frame.size.width / 2, height: photos[indexPath.row].height)
    //        } else if collectionView.tag == 2 {
    //            return CGSize(width: 75, height: 75)
    ...
    func collectionView(
        ...
        if collectionView.tag == 1 && kind == UICollectionView.elementKindSectionFooter {
            ...
            collectionView.dequeueReusableSupplementaryView(
                ...
                withReuseIdentifier: FooterCollectionReusableView.identifier, for: indexPath)
